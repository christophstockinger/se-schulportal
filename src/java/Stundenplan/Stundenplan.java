...
public class Stundenplan {
    ...
    public static String stundenplan() {
        ...
        output +=                           "</colgroup>";
        output +=                           "<tbody>";
        output +=                               "<tr><td class='dark'><div id='ar' class='redips-drag redips-clone ar'>Deutsch</div><input id='b_ar' class='ar' type='button' value='' onclick='redips.report('ar')' title='Show only Arts'/></td></tr>";
        output +=                               "<tr><td class='dark'><div id='bi' class='redips-drag redips-clone bi'>Mathematik</div><input id='b_bi' class='bi' type='button' value='' onclick='redips.report('bi')' title='Show only Biology'/></td></tr>";
        output +=                               "<tr><td class='dark'><div id='ch' class='redips-drag redips-clone ch'>HSU</div><input id='b_ch' class='ch' type='button' value='' onclick='redips.report('ch')' title='Show only Chemistry'/></td></tr>";
        output +=                               "<tr><td class='dark'><div id='en' class='redips-drag redips-clone en'>Englisch</div><input id='b_en' class='en' type='button' value='' onclick='redips.report('en')' title='Show only English'/></td></tr>";
        output +=                               "<tr><td class='dark'><div id='et' class='redips-drag redips-clone et'>Kunst</div><input id='b_et' class='et' type='button' value='' onclick='redips.report('et')' title='Show only Ethics'/></td></tr>";
