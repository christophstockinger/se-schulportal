        ...
        <main>
            <div class="row modul">
               ...
               <div class="col-12 col-sm-12 modul_form">
                    <h3>Kennzeichen löschen</h3>
                    
                    <form method="get" action="kfzDelete.jsp">
                        <input type="text" name="kennzeichen" placeholder="Bestätigen Sie ihr aktuelles Kennzeichen" id="kennzeichen">
