            ...
            <div class="col-10">
                ...
                <div class="hinzu">
                  ...
                  <%
                        ...
                        String tblname = Termine.databasetablename;
                        String id = "3";
                        
                        Boolean dbinsert = DBConnector.DBTermine(tblname, id, dat, zevo, zebi, bez);
                        
                        if (dbinsert){
                            out.println("Der Termin wurde erfolgreich hinzugefügt");
