...
<html>
    <head>
        ...
        <script type="text/javascript" src="/se-schulportal/templates/thd-schulportal/js/header.js"></script>
	<script type="text/javascript" src="/se-schulportal/templates/thd-schulportal/js/redips-drag-min.js"></script>
	<script type="text/javascript" src="/se-schulportal/templates/thd-schulportal/js/studenplandraganddrop.js"></script>
