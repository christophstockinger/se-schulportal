...
<html>
    <head>
        ...
        function kennzeichen(){
            ...
            window.location.replace("kfSucces.jsp?kennzeichen="+nkennzeichen+");
        }
        </script>
    ...
    <body>
        ...
        <form>
        <input type="text" name="nkennzeichen" placeholder="KFZ-Kennzeichen" id="kennzeichen" />
        <button type="button" class="button" onclick="kennzeichen()">Hinzufügen</button>
        </form>
