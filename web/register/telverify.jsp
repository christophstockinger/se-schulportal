...
<html>
    ...
    <body class='starterpager' style='overflow:scroll;'>
        <main>
            <div class="row content">
                ...
                <div class='col-12 col-sm-12 form_register'>
                    <h3>Verifizierung</h3>
                <%
                    String setButton = request.getParameter("telverify");
                    
                    if ( Boolean.parseBoolean(setButton) ) {
                        ...
                        int versuch = (Integer) session.getAttribute("versuch");

                        out.println( Verify.telVerify(email, pineingabe, pin, versuch) );
                        
                        session.setAttribute("versuch", (versuch + 1) );
                    } else {
                        out.println( "<p>Leider ist ein Fehler unterlaufen, bitte wende dich an den Administrator!</p>" );
                    }
                %>
                </div>
            </div>
